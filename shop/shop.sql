...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 22, 2021 at 10:42 AM
...
CREATE TABLE `admins` (
  ...
  `employessid` int(11) DEFAULT NULL
...
ALTER TABLE `admins`
  ADD PRIMARY KEY (`id`),
  ADD KEY `employessid` (`employessid`);
...
--
ALTER TABLE `admins`
  ADD CONSTRAINT `admins_ibfk_1` FOREIGN KEY (`employessid`) REFERENCES `employees` (`id`);
